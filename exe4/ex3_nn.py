...
num_lables = 10             # 10 labels, from 1 to 10 (note that we have mapped "0" to label 10)
...
data_1 = scipy.io.loadmat('ex3weights.mat')
Theta1 = data_1['Theta1']
Theta2 = data_1['Theta2']
